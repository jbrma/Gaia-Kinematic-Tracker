...
class Visualizer:
    ...
    def create_gif(self, df, ep, target_star, eval_times, N, number_sigma, output_folder, gif_filename, center_ra_past, center_dec_past):
        ...
        # Pulsar in the beginning of the GIF
        ...
        center_ra_static = (ns_ra_min + ns_ra_max) / 2.0
        center_dec_static = (ns_dec_min + ns_dec_max) / 2.0

        ra_span = abs(ns_ra_max - ns_ra_min)
        dec_span = abs(ns_dec_max - ns_dec_min)
        
        zoom_window_static = max(ra_span, dec_span) / 2.0 + 0.005
